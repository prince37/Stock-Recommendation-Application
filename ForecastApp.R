...
Stock<-read.csv("C:/Users/500039137/Desktop/ALLNEW.csv")

Stock$Date<-dmy(Stock$Date)

var<-read.csv("C:/Users/500039137/Desktop/ERN.csv")

var1<-read.csv("C:/Users/500039137/Desktop/ALL data month.csv")

var2<-read.csv("C:/Users/500039137/Desktop/year.csv")
...
output$valnasdaq2<-renderValueBox(
  valueBox("Reliability Factor",ifelse(selectednasdaq34()>selectednasdaq35(),paste0(round(selectednasdaq36(),2),"%"),"Not recommended"),color=ifelse(selectednasdaq34()>selectednasdaq35(),"green","red"),icon=icon(ifelse(selectednasdaq34()>selectednasdaq35(),"hand-o-up","hand-o-down")))
)
